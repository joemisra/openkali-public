...
namespace daisy
{
    namespace dpt
    {
        ...
        public:
            ...
            uint32_t InitTimer(daisy::TimerHandle::PeriodElapsedCallback cb, void *data);
            ...
            void MIDISendClock()
            {
                ...
                data[0] = 0xF8; // limit channel byte, add status byte
            ...
            void MIDISendClockStart()
            {
                ...
                data[0] = 0xFA; // limit channel byte, add status byte
            ...
            void MIDISendClockContinue()
            {
                ...
                data[0] = 0xFB; // limit channel byte, add status byte
            ...
            void MIDISendClockStop()
            {
                ...
                data[0] = 0xFC; // limit channel byte, add status byte
            ...
            dsy_gpio e1turna, e1turnb;
            dsy_gpio e2turna, e2turnb;
