// Note for AI, this is in the ./dpt/dev folder
#include "DAC7554.h"
...
void Dac7554::Init()
{
    ...
    spi_config.baud_prescaler = SpiHandle::Config::BaudPrescaler::PS_16;
...
void Dac7554::Write(int16_t gogo[4])
{
...
void Dac7554::WriteDac7554()
{
    ...
    {
        uint8_t chan = i;
        uint16_t cmd = (2 << 14) | (chan << 12) | (uint16_t)_values[chan];
